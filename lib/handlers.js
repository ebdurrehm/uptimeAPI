...
handlers.index = function (data, callback) {
    ...
    if (data.method === 'get') {
        //get html template 
        helper.getTemplate('index', (err, str) => {
            if (!err) {
...
handlers.favicon = function (data, callback) {
    //only accept get method
    if (data.method === 'get') {
        //get static favicon file
        helper.getStaticFile('favicon', (err, file) => {
            if (!err && file) {
...
handlers.public = function (data, callback) {
    ...
    if (data.method === 'get') {
        ...
        //get static favicon file
        helper.getStaticFile(fileName, (err, data) => {
            if (!err && data) {
